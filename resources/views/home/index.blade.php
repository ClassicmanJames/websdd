                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide dark">
                        ...
                        <div class="swiper-slide-bg cover"
                            style="background-image: url({{ asset('upload/silder/coverV3.jpg') }});"></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-container">
                            ...
                            <div class="tab-content clearfix" id="tab-pr">
                                <div data-readmore="true"
                                    ...
                                    data-readmore-trigger-close="Read Less <i class='icon-angle-up'></i>">
                                    <ul class="" style="padding-left: 20px;">
                                        <a href="{{ url('/maintenance') }}">
                                            <li class="list-group-item"><i class="icon-news"></i>
                                                ขอแสดงความยินดีกับนักศึกษาคณะอุตสาหกรรมเกษตร
                                                ได้รับรางวัลชนะเลิศประเภทผลิตภัณฑ์ส่วนผสมอาหารและเครื่องดื่ม Start-up
                                                Innovative F&B Products Competition ครั้งที่ 5
                                                ขอแสดงความยินดีกับนักศึกษาคณะอุตสาหกรรมเกษตร
                                                ได้รับรางวัลชนะเลิศประเภทผลิตภัณฑ์ส่วนผสมอาหารและเครื่องดื่ม Start-up
                                                Innovative F&B Products Competition ครั้งที่ 5</li>
                                        </a>
                                        <a href="{{ url('/maintenance') }}">
                                            <li class="list-group-item"><i class="icon-news"></i> ข่าวกิจกรรม</li>
                                        </a>
                                        <a href="{{ url('/maintenance') }}">
                                            <li class="list-group-item"><i class="icon-news"></i> ข่าวกิจกรรม</li>
                                        </a>
                            ...
                            <div class="portfolio-item">
                                <div class="portfolio-image">
                                    <a href="https://www.youtube.com/watch?v=HyaY2kl6LgM">
                                        <img src="{{ asset('upload/img/27.9.66 หน้าปก แนะนำ VDO กองพัฒน์.jpg') }}"
                                            alt="Locked Steel Gate">
                                    </a>
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content dark" data-hover-animate="fadeIn"
                                            data-hover-speed="350">
                                            <a class="grid-item" href="https://www.youtube.com/watch?v=HyaY2kl6LgM"
                        ...
                        <div class="oc-item">
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio-desc d-flex justify-content-center">
                                    ...
                                    <h3><a
                                            href="https://www.youtube.com/watch?v=HyaY2kl6LgM">{{ 'SDD CMU Introduction' }}</a>
                                    </h3>
                    ...
                    <div class="entry col-md-4 col-sm-6 col-12">
                        <div class="oc-item">
                            <div class="portfolio-item">
                                <div class="portfolio-image">
                                    <a href="https://www.youtube.com/watch?v=HyaY2kl6LgM">
                                        <img src="{{ asset('upload/service/pride-600x338.jpg') }}"
                                            alt="Locked Steel Gate">
                                    </a>
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content dark" data-hover-animate="fadeIn"
                                ...
                                <div class="portfolio-desc ">
                                    <h3><a href="https://www.youtube.com/watch?v=HyaY2kl6LgM">{{ 'ฉันภูมิใจที่ได้ใส่ชุดนักศึกษาของมชI am a pride of CMU' }}</a>
                                    </h3>
                            ...
                            <div class="portfolio-item">
                                <div class="portfolio-image">
                                    <a href="https://www.youtube.com/watch?v=85ySWDUnNUs">
                                        <img src="{{ asset('upload/service/smartCharacterCover-600x338.png') }}"
                                            alt="Locked Steel Gate">
                                    </a>
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content dark" data-hover-animate="fadeIn"
                                            data-hover-speed="350">
                                            <a class="grid-item" href="https://www.youtube.com/watch?v=85ySWDUnNUs"
                                                data-lightbox="iframe">
                                                <i class="icon-youtube-play"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="portfolio-desc">
                                    <h3><a
                                            href="https://www.youtube.com/watch?v=85ySWDUnNUs">{{ 'เป็น CMU SMART CHARACTER ในแบบของคุณ' }}</a>
                                    </h3>
                            ...
                            <div class="portfolio-item">
                                <div class="portfolio-image">
                                    <a href="https://www.youtube.com/watch?v=4UWsrnT90IA&t">
                                        <img src="{{ asset('upload/service/smart-1-800x450.jpg') }}"
                                            alt="Locked Steel Gate">
                                    </a>
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content dark" data-hover-animate="fadeIn"
                                            data-hover-speed="350">
                                            <a class="grid-item" href="https://www.youtube.com/watch?v=4UWsrnT90IA&t"
                                                data-lightbox="iframe">
                                                <i class="icon-youtube-play"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="portfolio-desc">
                                    <h3><a
                                            href="https://www.youtube.com/watch?v=4UWsrnT90IA&t">{{ 'เป็น CMU SMART STUDENTS ในแบบของคุณ' }}</a>
                                    </h3>
